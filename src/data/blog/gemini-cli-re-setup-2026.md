...
title: 【2026年最新】 おい！Gemini CLIの設定を見直した！
featured: false
draft: true
tags:
  - tech
description:
  ぶっちゃけClaude Codeしか使わないので設定しなくてもいい！
---
...
あるいは `GEMINI_CLI_SYSTEM_DEFAULTS_PATH` で上書き可能
...
`foo_project` というものがあったとして

- `foo_project/.gemini/settings.json`

### System settings file

企業のシステム管理者向け, 一般ユーザには無縁
...
あるいは `GEMINI_CLI_SYSTEM_SETTINGS_PATH` で上書き可能
